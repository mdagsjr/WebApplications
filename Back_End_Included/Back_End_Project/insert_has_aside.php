...
function insert_has_aside($values) {
	...
	$sql = "INSERT INTO ma21dago_has_aside (pageid, asideid, ord) VALUES ('$pageid','$asideid','$ord')";
...
if ($_POST && $_GET['action']=="insert") {
	...
	echo '
		...
		<p><a href="insert_has_aside.php" class="btn btn-success">Insert Another Has Aside</a></p>
